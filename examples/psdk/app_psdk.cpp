...
class win_sparkle_update_manager
{

public:
    static void on_did_find_update_check_complete() {
        int x = 0;
    };
	static void on_did_not_find_update_check_complete() {
		int x = 0;
	};
	static void on_win_sparkle_set_update_cancelled_callback() {
		int x = 0;
	};
	static int on_user_run_installer_callback(const wchar_t* path)
	{
		int x = 0;
        return 1;
	};
	...
	static int on_win_sparkle_can_shutdown_callback()
	{
		int x = 0;
        return 1;
	};
	static void on_win_sparkle_set_shutdown_request_callback()
	{
		int x = 0;
	};
	static void on_win_sparkle_set_update_skipped_callback()
	{
		int x = 0;
	};
	static void on_win_sparkle_set_update_postponed_callback()
	{
		int x = 0;
	};
	static void on_win_sparkle_set_update_dismissed_callback()
	{
		int x = 0;
	};
                       ...
                       UINT codeNotify)
{
    if ( id == IDB_CHECK_FOR_UPDATES )
    {
		...
		win_sparkle_set_did_find_update_callback(win_sparkle_update_manager::on_did_find_update_check_complete);
		win_sparkle_set_did_not_find_update_callback(win_sparkle_update_manager::on_did_not_find_update_check_complete);
		win_sparkle_set_update_cancelled_callback(win_sparkle_update_manager::on_win_sparkle_set_update_cancelled_callback);
		win_sparkle_set_error_callback(win_sparkle_update_manager::on_win_sparkle_error_callback);
		win_sparkle_set_can_shutdown_callback(win_sparkle_update_manager::on_win_sparkle_can_shutdown_callback);
		win_sparkle_set_shutdown_request_callback(win_sparkle_update_manager::on_win_sparkle_set_shutdown_request_callback);
		win_sparkle_set_update_skipped_callback(win_sparkle_update_manager::on_win_sparkle_set_update_skipped_callback);
		// Set the callback to handle the downloaded installer
        win_sparkle_set_user_run_installer_callback(win_sparkle_update_manager::on_user_run_installer_callback);
        //win_sparkle_set_installer_package_callback(win_sparkle_update_manager::on_win_sparkle_set_installer_package_callback);

        win_sparkle_set_installer_package_callback(win_sparkle_update_manager::on_win_sparkle_set_installer_package_callback);
		win_sparkle_set_update_postponed_callback(win_sparkle_update_manager::on_win_sparkle_set_update_postponed_callback);
		win_sparkle_set_update_dismissed_callback(win_sparkle_update_manager::on_win_sparkle_set_update_dismissed_callback);
